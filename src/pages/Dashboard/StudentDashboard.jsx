...
function StudentDashboard(props) {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" className="content-parent" sx={{ padding: "2em" }}>
        {/* Content render */}
        <Box>{content}</Box>
      </Box>
    </Box>
    ...
    <Box className="content">
      ...
      >
        {subject.map((sub) => {
          return (
            <Card
              sx={{ minWidth: "10em", marginRight: "1em", marginTop: "1em" }}
            >
              <CardContent>
                <Typography
                  sx={{ fontSize: 14 }}
  ...
  return (
    <Box sx={{}}>
      ...
      >
        {Exams.map((sub) => {
          return (
            <Card sx={{ minWidth: 275, marginRight: "1em", marginTop: "1em" }}>
              <CardContent>
              ...
              <CardActions sx={{ justifyContent: "center" }}>
                <Button
                  size="small"
                  color="error"
                  onClick={() => (window.location.href = `/Quiz/${sub.examId}`)}
                >
                  Take test!
                </Button>
              </CardActions>
